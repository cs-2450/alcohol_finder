...
CREATE TABLE stores (id INT, store_number VARCHAR(255), store_name VARCHAR(255), street_address VARCHAR(255), city VARCHAR(255), phone_number VARCHAR(255), created_at DATETIME, updated_at DATETIME, hours VARCHAR(255), latitude VARCHAR(255), longitude VARCHAR(255));
